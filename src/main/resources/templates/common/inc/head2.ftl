    ...
    <link rel="stylesheet" href="${request.contextPath}/AdminLTE/dist/css/skins/skin-blue.min.css">

    <link rel="stylesheet" href="${request.contextPath}/bootstrap-table/bootstrap-table.min.css">
